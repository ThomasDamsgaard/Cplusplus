...
int main(int argc, char **argv)
{
    ...
    //(<<) can be used multiple times in a single statement to concatenate 
    // (link together) multiple pieces of output. For example:
    ...
    // Whereas std::cout prints data to the console using the insertion operator (<<), 
    // std::cin (which stands for “character input”) reads input from keyboard using 
    // the extraction operator (>>). The input must be stored in a variable to be used.
